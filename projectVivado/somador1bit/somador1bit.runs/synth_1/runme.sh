...
HD_PWD='C:/Users/carlo/somador1bit/somador1bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log somador1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source somador1.tcl
