...
HD_PWD='C:/Users/carlo/somador1bit/somador1bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log somador1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source somador1.tcl -notrace
